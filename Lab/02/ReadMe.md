...
Клиент для сохранения данных использует веб сервер. Сервер слушает запросы по адресу /. Когда приходит запрос, содержащий JSON данные, он обрабатывает их, далее заносит данные в таблицу, если она уже создана или создает, а потом уже вводит их. После опреденного количества записаных строк таблицы, файл сохраняется. 

[XLSX Таблица](Python/data.xlsx)
